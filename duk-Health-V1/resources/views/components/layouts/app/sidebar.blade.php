...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        {{-- Nueva Venta --}}
        <flux:navlist class="w-64" variant="outline">
            <flux:navlist.group heading="Nueva Venta o Servicio" expandable :expanded="false" class="max-lg:hidden">
        ...
        <flux:navlist class="w-64" variant="outline">
            <flux:navlist.group heading="Seguridad & salud en el trabajo" icon="clipboard-list" expandable :expanded="false"
                class="max-lg:hidden">
                <flux:navlist.item href="#" icon="magnifying-glass-circle">Consultar</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
